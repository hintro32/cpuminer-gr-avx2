...
//   } u;
  ...
  if (kc->ptr == (lim - 8)) {
    ...
    tmp[0] = m512_const1_64(t);
    j = 8;
  } else {
    j = lim - kc->ptr;
    tmp[0] = m512_const1_64(eb);
    memset_zero_512(tmp + 1, (j >> 3) - 2);
    tmp[(j >> 3) - 1] = m512_const1_64(0x8000000000000000);
  }
...
//   } u;
  ...
  if (kc->ptr == (lim - 8)) {
    const uint64_t t = eb | 0x8000000000000000;
    tmp[0] = m256_const1_64(t);
    j = 8;
  } else {
    j = lim - kc->ptr;
    tmp[0] = m256_const1_64(eb);
    memset_zero_256(tmp + 1, (j >> 3) - 2);
    tmp[(j >> 3) - 1] = m256_const1_64(0x8000000000000000);
  }
